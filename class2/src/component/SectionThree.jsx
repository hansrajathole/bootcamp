  ...
  return (
    <div className="mt-14 w-full px-12">
      ...
      <div className=" w-full flex justify-end mt-5">
        <button className="px-5  py-4 font-semibold border-2 border-black rounded-[1em] hover:rounded-[2em] ease-linear duration-300 ">Alle projecten <i class="ri-arrow-right-line ml-3"></i></button>
      </div>
    </div>
  );
};
